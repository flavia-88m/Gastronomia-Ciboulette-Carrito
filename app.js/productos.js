...
// Creo  un mensaje de bienvenida con jQuery
...
mensajeBienvenida.append("<h2> Todas nuestas variedades son 100% artesanales, nos destacamos por:<h2>");
...
// Creo los objetos de mi carrito
  ...
  productosCarrito() {
      return ` ${this.id} ${this.name} ${this.Variedad} ${this.price}`
      }
  };
...
let newObject1 = {id: 1, name:"Sorrentinos", Variedad: "Jamon ricota y queso muzzarella", price: 400, imagen:"http://d3ugyf2ht6aenh.cloudfront.net/stores/099/082/products/sorrentinos2-generico-ciudadmadre1-ce043e156bcd8c9b7715132736013212-640-0.jpg" };
...
let newObject2 = {id:2, name:"Sorrentinos", Variedad: "Pollo, cebolla, morrones, espinaca y ricota", price: 450, imagen:"http://www.polidoripastas.com.ar/media/productos/frescas-sorrentinos-espinaca-mozzarella-pollo.jpg" };
...
let newObject3 = {id:3, name:"Sorrentinos", Variedad: "Calabaza asada, cebolla, ricota, hierbas frescas y queso muzzarella", price: 420, imagen:"https://i.pinimg.com/originals/6f/f5/cc/6ff5cce6aba7b313186a54531b201fb4.jpg"};
...
let newObject4 = {id:4, name:"Sorrentinos", Variedad: "Espinaca, cebolla, ricota y queso muzzarella", price: 420, imagen: "https://i.pinimg.com/564x/e5/88/15/e58815cbbb32214eb7154669e9d19f7e.jpg" };
...
let newObject5 = {id:5, name:"Sorrentinos", Variedad: "Jamon, ricota, nueces y queso muzzarella", price: 500, imagen:"http://www.polidoripastas.com.ar/media/productos/frescas-sorrentinos-jamon-mozzarella-albahaca.jpg" };
...
let newObject6 = {id:6, name:"Ravioles", Variedad: "Ricota y queso muzzarella", price: 270, imagen:"https://images.rappi.com.ar/products/94308060-ab3f-4334-9ab0-82bc13afb814-1601668414149.jpeg?d=128x90"};
...
let newObject7 = {id:7, name:"Tallarines", Variedad: "Al huevo", price: 250, imagen:"https://st.depositphotos.com/1177973/4796/i/600/depositphotos_47960177-stock-photo-still-life-with-raw-homemade.jpg" };
...
let newObject8 = {id:8, name:"Tallarines", Variedad: "Espinaca", price: 250, imagen:"https://cuk-it.com/wp-content/uploads/2020/10/thumb02-7-1024x576.jpg" };
